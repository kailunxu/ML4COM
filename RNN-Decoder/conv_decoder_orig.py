...
def get_args():
    ...
    parser.add_argument('-num_block', type=int, default=1000) # WAS 5000
    ...
    parser.add_argument('-batch_size',  type=int, default=10) # WAS 10
    parser.add_argument('-learning_rate',  type=float, default=0.001)
    parser.add_argument('-num_epoch',  type=int, default=8) # WAS 20
